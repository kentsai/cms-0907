...
/** A profile whose token carries the given roles, shaped like `POST /api/auth/login` returns it. */
export function fakeProfile(roles: string[] = ['Admin'], userName = '陳小美', userId = 'mei'): UserProfile {
...
export function seedSignedInUser(roles: string[] = ['Admin'], userName = '陳小美'): UserProfile {
